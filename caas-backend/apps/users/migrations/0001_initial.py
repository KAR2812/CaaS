    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('portfolio_slug', models.SlugField(blank=True, null=True, unique=True)),
                ('portfolio_bio', models.TextField(blank=True)),
                ('portfolio_theme', models.CharField(choices=[('light', 'Light'), ('dark', 'Dark')], default='light', max_length=20)),
